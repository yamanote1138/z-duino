...
- **Frontend** (`frontend/`) — Vue 3 + Vite + Bootstrap 5. Throttle UI with 10-segment speed bar, smooth ramping, direction toggle. Built to `build/data/` for LittleFS.
...
- 12V DC power supply
- Pins: D1=PWMA, D2=AIN2, D3=AIN1, D4=STBY
